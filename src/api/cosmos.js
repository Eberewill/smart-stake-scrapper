...
router.get('/', async (req, res) => {
  try {
    const url = 'https://7nkwv3z5t1.execute-api.us-east-1.amazonaws.com/prod/listData?type=getPool&address=cosmosvaloper17mggn4znyeyg25wd7498qxl7r2jhgue8u4qjcq&frequencyHour=8H&frequencyDay=10D&key=2mwTEDr9zXJH323M&token=1657413873&app=ATOM'
 await puppeteer
      .launch({
        args: [
          '--no-sandbox',
